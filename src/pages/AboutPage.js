...
Тексты диалога делятся на два типа:</p>
        ...
        <p>Поле для ввода текста содержит две видимые строки. При вводе более длинного текста он будет смещаться вверх и скрываться. В правой части имеется кнопка для отправки сообщения.</p>
